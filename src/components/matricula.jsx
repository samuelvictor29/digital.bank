...
export default function Matricula() {
    ...
    const aposRegistroNome = (e) => {
        setNome(e.target.value);
    };
    const aposRegistroEmail = (e) => {
        ...
        <div className="flex flex-column">
				<div className="formulario flex flex-column">
					...
					<div className="flex flex-column">
						...
						<input onChange={aposRegistroNome} value={nome} type="text" id="nome" />
					</div>
					...
					<div className="flex flex-column">
						...
						<input onChange={aposRegistroEmail} type="text" id="telefone" />
					</div>

					<div className="flex flex-column">
						<label for="telefone" >Digite seu senha</label>
                        <input type = {passwordVisible ? "text" : "password"} id="telefone" />
						<button className="mostra-senha" onClick={togglePasswordVisibility}> {passwordVisible ? "Ocultar" : "Exibir senha"}</button>
					</div>
